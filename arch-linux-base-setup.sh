...
# Before hop in
sudo pacman -Syy &&
    sudo pacman -S --needed --noconfirm 9base arch-install-scripts binutils curl fonts-terminus git gnupg haveged kmod pacman-contrib psmisc ufw wget xdg-utils
