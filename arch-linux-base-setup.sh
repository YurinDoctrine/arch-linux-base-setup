...
# Before hop in
sudo pacman -Syy &&
    sudo pacman -S --needed --noconfirm 9base arch-install-scripts binutils curl fonts-terminus git gnupg haveged iwd kmod pacman-contrib pkgconf psmisc ufw wget xdg-utils
